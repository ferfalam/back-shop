                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('settings.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <select class="form-control aiz-selectpicker" name="system_default_currency" data-live-search="true" data-selected="{{ get_setting('system_default_currency') }}">
                ...
                <div class="card-body">
                    <form class="form-horizontal" action="{{ route('settings.update') }}" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <select class="form-control aiz-selectpicker" name="symbol_format" data-selected="{{ get_setting('symbol_format') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <select class="form-control aiz-selectpicker" name="decimal_separator" data-selected="{{ get_setting('decimal_separator') }}">
                                    <option value="1">1,234,567.80</option>
                                    <option value="2">1.234.567,80</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-lg-6">
                                <select class="form-control aiz-selectpicker" name="no_of_decimals" data-selected="{{ get_setting('no_of_decimals') }}">
...
<div class="card">
    <div class="card-header row gutters-5">
        <div class="col text-center text-md-left">
            <h5 class="mb-md-0 h6">{{ translate('Currencies') }}</h5>
        </div>
        <div class="col-md-4">
                    ...
                    <tr>
                        ...
                        {{-- <td>
                            <label class="aiz-switch aiz-switch-success mb-0">
                                <input onchange="update_currency_status(this)" value="{{ $currency->id }}" type="checkbox" @if($currency->status == 1) checked @endif >
